...
#define NL_MINOR_VERSION 63
#define NL_VERSION_STRING "HawkNL 1.63"
...
#define NL_UDP_MULTICAST        NL_MULTICAST
...
#define NL_MUTEX_RECURSION      0x011f  /* the mutex was recursivly locked or unlocked */
/* for backwards compatability */
